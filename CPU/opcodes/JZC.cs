...
{
    [Opcode(OpcodeBaseCode.JZC, OpcodeGroupBaseCode.SystemAndJump)]
    internal class JZC : BaseOpcode
    {
        public JZC(byte instructionByte, State state, Memory memory, Stack stack)
        {
            _state = state;
            _memory = memory;
#if x16
