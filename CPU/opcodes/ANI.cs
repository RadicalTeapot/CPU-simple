...
{
    [Opcode(OpcodeBaseCode.ANI, OpcodeGroupBaseCode.SingleRegisterLogicOne)]
    internal class ANI : BaseOpcode
    {
        public ANI(byte instructionByte, State state, Memory memory, Stack stack)
        {
            _state = state;
            _memory = memory;
